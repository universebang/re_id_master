...
import time
import os
from model import ft_net,ft_net_dense,PCB,ft_net_middle,ft_net_attention
...
parser.add_argument('--data_dir',default='/home/deepnorth/CVPR-2018/Market-1501-v15.09.15/pytorch/',type=str, help='training dir path')
...
def draw_curve(current_epoch):
    ...
    ax0.plot(x_epoch, y_loss['train'], 'bo-', label='train')#epoch_loss
    ax0.plot(x_epoch, y_loss['val'], 'ro-', label='val')
    ax1.plot(x_epoch, y_err['train'], 'bo-', label='train')#1.0-epoch_acc
